...
namespace Qwirkle.Core.ComplianceContext.Tests
{
    public class CanTilesBePlayedShould
    {
        ...
        public void ReturnNumberOfTilesWhenBoardIsEmptyAndTilesMakeRow()
        {
            ...
            Assert.True(0 < _complianceService.CanTilesBePlayed(board, new List<Tile> { new Tile(TileColor.Blue, TileForm.Ring, new CoordinatesInBoard(1, 5)) }));
            Assert.True(0 < _complianceService.CanTilesBePlayed(board, new List<Tile> { new Tile(TileColor.Blue, TileForm.Ring, new CoordinatesInBoard(13, 69)), new Tile(TileColor.Purple, TileForm.Ring, new CoordinatesInBoard(12, 69)) }));
            Assert.Equal(1, _complianceService.CanTilesBePlayed(board, new List<Tile> { new Tile(TileColor.Blue, TileForm.Ring, new CoordinatesInBoard(1, 5)) }));
            Assert.Equal(2, _complianceService.CanTilesBePlayed(board, new List<Tile> { new Tile(TileColor.Blue, TileForm.Ring, new CoordinatesInBoard(13, 69)), new Tile(TileColor.Purple, TileForm.Ring, new CoordinatesInBoard(12, 69)) }));
        }
        ...
        {
            var board = new Board(1, new List<Tile>());
            Assert.Equal(0, _complianceService.CanTilesBePlayed(board, new List<Tile> { new Tile(TileColor.Blue, TileForm.Ring, new CoordinatesInBoard(1, 5)), new Tile(TileColor.Purple, TileForm.Ring, new CoordinatesInBoard(2, 4)) }));
            Assert.Equal(0, _complianceService.CanTilesBePlayed(board, new List<Tile> { new Tile(TileColor.Blue, TileForm.Ring, new CoordinatesInBoard(8, 12)), new Tile(TileColor.Yellow, TileForm.Ring, new CoordinatesInBoard(9, 12)), new Tile(TileColor.Purple, TileForm.Ring, new CoordinatesInBoard(6, 12)) }));
        }
        ...
        public void Return0WhenTilesAreInTheSamePlace()
        {
            ...
            Assert.Equal(0, _complianceService.CanTilesBePlayed(board, new List<Tile> { new Tile(TileColor.Green, TileForm.Ring, new CoordinatesInBoard(6, -3)), new Tile(TileColor.Green, TileForm.Star4, new CoordinatesInBoard(6, -3)) }));
            Assert.Equal(0, _complianceService.CanTilesBePlayed(board, new List<Tile> { new Tile(TileColor.Green, TileForm.Ring, new CoordinatesInBoard(6, -3)), new Tile(TileColor.Green, TileForm.Star4, new CoordinatesInBoard(6, -3)), new Tile(TileColor.Green, TileForm.Shape, new CoordinatesInBoard(5, -3)) }));
            Assert.Equal(0, _complianceService.CanTilesBePlayed(board2, new List<Tile> { new Tile(TileColor.Green, TileForm.Ring, new CoordinatesInBoard(6, -3)), new Tile(TileColor.Green, TileForm.Star4, new CoordinatesInBoard(6, -3)) }));
            Assert.Equal(0, _complianceService.CanTilesBePlayed(board2, new List<Tile> { new Tile(TileColor.Green, TileForm.Ring, new CoordinatesInBoard(6, -3)), new Tile(TileColor.Green, TileForm.Star4, new CoordinatesInBoard(6, -3)), new Tile(TileColor.Green, TileForm.Shape, new CoordinatesInBoard(5, -3)) }));
        }
        ...
        public void Return2When1GoodTileIsAround1TileOnBoard()
        {
            ...
            Assert.Equal(2, _complianceService.CanTilesBePlayed(board, new List<Tile> { new Tile(TileColor.Purple, TileForm.Square, new CoordinatesInBoard(8, -3)) }));
            Assert.Equal(2, _complianceService.CanTilesBePlayed(board, new List<Tile> { new Tile(TileColor.Purple, TileForm.Square, new CoordinatesInBoard(6, -3)) }));
            Assert.Equal(2, _complianceService.CanTilesBePlayed(board, new List<Tile> { new Tile(TileColor.Purple, TileForm.Square, new CoordinatesInBoard(7, -4)) }));
            Assert.Equal(2, _complianceService.CanTilesBePlayed(board, new List<Tile> { new Tile(TileColor.Purple, TileForm.Square, new CoordinatesInBoard(7, -2)) }));
        }
        ...
        public void Return4When1TileMakeValidColumnWith3BoardTiles()
        {
            ...
            Assert.Equal(4, _complianceService.CanTilesBePlayed(board, new List<Tile> { new Tile(TileColor.Purple, TileForm.Square, new CoordinatesInBoard(7, -6)) }));
            Assert.Equal(4, _complianceService.CanTilesBePlayed(board, new List<Tile> { new Tile(TileColor.Red, TileForm.Square, new CoordinatesInBoard(7, -2)) }));
            Assert.Equal(4, _complianceService.CanTilesBePlayed(board, new List<Tile> { new Tile(TileColor.Yellow, TileForm.Square, new CoordinatesInBoard(7, -2)) }));
        }
        ...
        public void Return4When1TileMakeValidLineWith3BoardTiles()
        {
            ...
            Assert.Equal(4, _complianceService.CanTilesBePlayed(board, new List<Tile> { new Tile(TileColor.Purple, TileForm.Square, new CoordinatesInBoard(6, -4)) }));
            Assert.Equal(4, _complianceService.CanTilesBePlayed(board, new List<Tile> { new Tile(TileColor.Red, TileForm.Square, new CoordinatesInBoard(10, -4)) }));
            Assert.Equal(4, _complianceService.CanTilesBePlayed(board, new List<Tile> { new Tile(TileColor.Yellow, TileForm.Square, new CoordinatesInBoard(10, -4)) }));
        ...
        public void Return2When1GoodTileTouch1TileInBoardOnSide()
        {
            ...
            Assert.True(0 < _complianceService.CanTilesBePlayed(board, new List<Tile> { new Tile(TileColor.Purple, TileForm.Square, new CoordinatesInBoard(9, -5)) }));
            Assert.Equal(2, _complianceService.CanTilesBePlayed(board, new List<Tile> { new Tile(TileColor.Purple, TileForm.Square, new CoordinatesInBoard(9, -5)) }));
        }
        ...
        public void Return5When2TilesWithFirstTouchTileInBoard()
        {
            ...
            Assert.True(0 < _complianceService.CanTilesBePlayed(board, new List<Tile> { new Tile(TileColor.Purple, TileForm.Square, new CoordinatesInBoard(10, -4)), new Tile(TileColor.Yellow, TileForm.Square, new CoordinatesInBoard(11, -4)) }));
        ...
        public void Return5When2TilesWithSecondTouchTileInBoard()
        {
            ...
            Assert.True(0 < _complianceService.CanTilesBePlayed(board, new List<Tile> { new Tile(TileColor.Purple, TileForm.Square, new CoordinatesInBoard(11, -4)), new Tile(TileColor.Yellow, TileForm.Square, new CoordinatesInBoard(10, -4)) }));
        ...
        public void Return7When3TilesRowTouch3BoardTileLine()
        {
            ...
            Assert.True(0 < _complianceService.CanTilesBePlayed(board, new List<Tile> { new Tile(TileColor.Yellow, TileForm.Trefail, new CoordinatesInBoard(10, -5)), new Tile(TileColor.Yellow, TileForm.Square, new CoordinatesInBoard(10, -4)), new Tile(TileColor.Yellow, TileForm.Star8, new CoordinatesInBoard(10, -3)) }));
        ...
        public void Return24WhenAQwirkleYellowLineTouchQwirklePurpleLine()
        {
            ...
            Assert.Equal(6 + 6 + 2 * QWIRKLE_POINTS, _complianceService.CanTilesBePlayed(board, tilesTested));
        }
        ...
        public void Return12When2TilesAreInTheSame4BoardTilesColumn()
        {
            ...
            Assert.Equal(6 + QWIRKLE_POINTS, _complianceService.CanTilesBePlayed(board, tilesTested));
            Assert.Equal(6 + QWIRKLE_POINTS, _complianceService.CanTilesBePlayed(board, tilesTested2));
        }
