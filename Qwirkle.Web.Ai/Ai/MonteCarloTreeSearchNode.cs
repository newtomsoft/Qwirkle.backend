...
public class MonteCarloTreeSearchNode
{
    ...
    public HashSet<TileOnBoard> ParentAction { get; set; }
    ...
    public MonteCarloTreeSearchNode(Game gameNode, MonteCarloTreeSearchNode parentNode = null, HashSet<TileOnBoard> parentActionNode = null)
    {
