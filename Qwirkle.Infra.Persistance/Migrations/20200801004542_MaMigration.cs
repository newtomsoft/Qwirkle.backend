        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GameTurn = table.Column<bool>(nullable: false),
                    GamePosition = table.Column<byte>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TileOnGame", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TileOnGame_Games_GameId",
                        column: x => x.GameId,
                        principalTable: "Games",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TileOnGame_Tile_TileId",
                        column: x => x.TileId,
                        principalTable: "Tile",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TileOnGame_GameId",
                table: "TileOnGame",
                column: "GameId");

            migrationBuilder.CreateIndex(
                name: "IX_TileOnGame_TileId",
                table: "TileOnGame",
                column: "TileId");
