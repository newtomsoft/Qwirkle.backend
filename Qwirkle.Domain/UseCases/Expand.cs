namespace Qwirkle.Domain.UseCases
{
...

    {
        ...
        public static MonteCarloTreeSearchNode ExpandMcts(MonteCarloTreeSearchNode mcts,
         List<PlayReturn> playReturns, int indexPlayer)
        {
            foreach (var coordinate in playReturns)
            {
                 ...
                 coordinate.TilesPlayed.ForEach(tileBoard =>
                {
                    ...
                    {
                        int index = random.Next(newgame.Bag.Tiles.Count);
                ...
                MonteCarloTreeSearchNode childrenNode = new MonteCarloTreeSearchNode(newgame, mcts, coordinate.TilesPlayed);
                childrenNode = Expand.SetNextPlayerTurnToPlay(childrenNode, childrenNode.game.Players[indexPlayer]);
