...
{
    public void ArrangeRack(Player player, List<int> tilesIds) => throw new NotImplementedException();
    ...
    public void TilesFromPlayerToBag(Player player, IEnumerable<int> tilesIds) => throw new NotImplementedException();
