...
public class PlayTilesShould
{
    ...
    public void Return3After1PlayerHavePlayedHisTiles()
    {
        ...
        ComplianceService.TryPlayTiles(PLAYER9, tilesToPlay).Points.ShouldBe(3);
    }
    ...
    public void Return0WhenItsNotTurnPlayer()
    {
        ...
        ComplianceService.TryPlayTiles(PLAYER3, tilesToPlay).Points.ShouldBe(0);
    }
    ...
    public void Return0After1PlayerHavePlayedNotHisTiles()
    {
        ...
        ComplianceService.TryPlayTiles(PLAYER9, tilesToPlay).Points.ShouldBe(0);
    }
    ...
    public void Return5After2PlayersHavePlayed()
    {
        ...
        ComplianceService.TryPlayTiles(PLAYER3, tilesToPlay2).Points.ShouldBe(5);
    }
    ...
    public void Return6After4PlayersHavePlayed()
    {
        ...
        ComplianceService.TryPlayTiles(PLAYER14, tilesToPlay4).Points.ShouldBe(6);
    }
    ...
    public void Return0AfterPlayersHavePlayedOnTheSamePlaceThanOtherTile()
    {
        ...
        ComplianceService.TryPlayTiles(PLAYER9, tilesToPlay5).Points.ShouldBe(0);
    }
